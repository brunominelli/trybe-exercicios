...
if (piece.toLowerCase() === pawn) {
    ...
    console.log('Torre: O movimento é frontal ou lateral assim como o ataque.');
    ...
    console.log('Rainha: O movimento é o que ela quiser em qualquer direção, exceto em L, porque ela é a Rainha assim como o ataque.');

} else if (piece.toLowerCase() === king) {

    console.log('Rei: O movimento é o que ele quiser em qualquer direção, exceto em L, mas só pode dar um passo de cada vez.');
