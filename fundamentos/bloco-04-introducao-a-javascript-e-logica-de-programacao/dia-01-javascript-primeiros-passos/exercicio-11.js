...
if (salarioBruto <= 1556.94){
    ...
    console.log('Salário bruto de R$ 1.556,95 a R$ 2.594,92: alíquota de 9%.\n');
...
if (salarioBruto <= 1903.98) {
    ...
    console.log('Salário entre R$ 1.903,99 a 2.826,65: alíquota de 7,5% e parcela de R$ 142,80 a deduzir do imposto.\n');
    aliquotaIR = (salarioBruto * 0.075) - 142.8;
    salarioLiquido = salarioBruto - aliquotaIR;

} else if (salarioBruto >= 2826.66 && salarioBruto <= 3751.05){

    console.log('Salário entre R$ 2.826,66 a R$ 3.751,05: alíquota de 15% e parcela de R$ 354,80 a deduzir do imposto.\n'); 
    aliquotaIR = (salarioBruto * 0.15) - 354.8;
    salarioLiquido = salarioBruto - aliquotaIR;

} else if (salarioBruto >= 3751.6 && salarioBruto <= 4664.68){

    console.log('Salário entre R$ 3.751,06 a R$ 4.664,68: alíquota de 22,5% e parcela de R$ 636,13 a deduzir do imposto.\n');
