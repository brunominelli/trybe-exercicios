...
// Isso ocorre porque a classe tech tem a propriedade transform que desloca a caixa em questão 20px no eixo Y.
...
myWebpage.addEventListener('dblclick', function(){
  window.location.replace('https://obrunominelli.github.io');
})
